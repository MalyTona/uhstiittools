...
const errorKeys: Record<string, TranslationKey> = {
  ...
  TOO_MANY_CONVERT_FILES: "error_TOO_MANY_CONVERT_FILES",
  ...
  INVALID_IMAGE_FORMAT: "error_INVALID_IMAGE_FORMAT",
  IMAGE_PAGE_TOO_LARGE: "error_IMAGE_PAGE_TOO_LARGE",
  IMAGE_OUTPUT_TOO_LARGE: "error_IMAGE_OUTPUT_TOO_LARGE",
